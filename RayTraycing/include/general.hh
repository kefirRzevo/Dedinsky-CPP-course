...
public:
  ...
  void Print() const { printf("%hhu %hhu %hhu\n", R, G, B); }
};
...
public:
  ...
  Material() : matColor(Color()), matKd(0), matKs(0), matKr(0) {};
...
public:
  ...
  Radiation() : radColor(Color()), radKa(0) {};

  Radiation(Color col, float Ka) : radColor(col), radKa(Ka) {};
