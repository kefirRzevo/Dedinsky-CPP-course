...
public:
  ...
  Light(Vector pos, Radiation rad) : lightPosition(pos), lightRadiation(rad) {};
...
public:
  Scene(const Camera &camera) : sceneCamera(camera) {};
  ...
  void AddSphere(Sphere sphere) { sceneShapes.push_back(sphere); }
