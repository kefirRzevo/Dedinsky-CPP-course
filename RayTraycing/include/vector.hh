...
public:
  ...
  Vector(float anX, float anY, float anZ) : x(anX), y(anY), z(anZ) {};
  ...
  float GetLen() const { return std::sqrt(x * x + y * y + z * z); }

  float GetSquaredLen() const { return x * x + y * y + z * z; }
  ...
  void Print() const { printf("%8.4lf %8.4lf %8.4lf\n", x, y, z); }
};
