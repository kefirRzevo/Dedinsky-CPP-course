...
public:
  ...
  Vector(double anX) : x(anX), y(0), z(0) {};

  Vector(double anX, double anY) : x(anX), y(anY), z(0) {};

  Vector(double anX, double anY, double anZ) : x(anX), y(anY), z(anZ) {};

  ~Vector() {}

  void PrintVector() { std::cout << x << ";\t" << y << ";\t" << z << "\n"; }
  ...
  double GetLen() { return std::sqrt(x * x + y * y + z * z); }

  double GetSquareLen() { return x * x + y * y + z * z; }
